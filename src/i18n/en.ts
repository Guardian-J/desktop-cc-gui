...
export const en: Messages = {
  ...
  plugins: {
    ...
    hub: {
      ...
      heroTitle: "Make CC GUI work your way",
      heroSubtitle:
        "Install community plugins to extend what it can do, or load one you're building from a local directory.",
    ...
    market: {
      ...
      localSteps: [
        ...
        "Plugins → Install from directory, pick the repo root to load and debug; rebuild and reload after changes",
      ],
