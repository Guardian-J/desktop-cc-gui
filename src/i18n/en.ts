...
export const en: Messages = {
  ...
  computerUse: {
    title: "Computer Use",
    toggleTooltip: "Let the AI see your screen and control mouse & keyboard",
    dialogTitle: "Enable Computer Use",
    dialogDesc: "Once enabled, the AI can view your screen and control the mouse and keyboard on this machine.",
    riskTitle: "Before you enable",
    riskScreen: "The AI can see everything on screen, including private information.",
    riskControl: "The AI really clicks and types — mistakes are possible. Save important work first.",
    riskEsc: "Press Esc at any time while a run is active to stop immediately.",
    permAccessibility: "Accessibility",
    permAccessibilityDesc: "Allows controlling the mouse and keyboard",
    permScreenRecording: "Screen Recording",
    permScreenRecordingDesc: "Allows capturing the screen",
    granted: "Granted",
    notGranted: "Not granted",
    authorize: "Authorize",
    checking: "Checking permissions…",
    dragHint: "You can also drag me into the permission list in System Settings to authorize directly",
    dragCard: "Drag me over",
    noPermissionNeeded: "No extra OS permission is needed on this system",
    engineNote: "Supported on Claude Code and OMP engines.",
    settingsHint: "You can also enable it for the current chat from the composer toolbar.",
    needPermissions: "Grant the permissions above first",
    enable: "Enable",
  },
};
