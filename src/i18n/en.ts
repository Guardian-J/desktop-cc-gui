...
export const en: Messages = {
  ...
  settings: {
    ...
    pet: "Desktop pet",
    petDesc: "A draggable always-on-top companion that reflects chat and mission activity.",
    petEnabled: "Show desktop pet",
    petEnabledDesc: "Off by default; the pet runs in its own transparent window.",
    petCharacter: "Character",
    petImport: "Import pet",
    petImportHint: "Choose a folder containing pet.json and its declared spritesheet.",
    petRemove: "Remove",
    petBuiltIn: "Built-in",
    petImportSuccess: "Pet imported.",
    petImportFailed: "Pet import failed",
    petRemoveConfirm: "Remove this imported pet?",
    proxy: "Network Proxy",
    proxyDesc:
